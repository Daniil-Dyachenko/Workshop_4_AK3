...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  // Отримуємо 1 байт по UART3 з затримкою в 10 мс
	  ...
	  if (result == HAL_OK)
	  {
	      ...
	      switch (rcvBuf[0])
	      {
	      case 'g': // Перемикаємо ЗЕЛЕНИЙ світлодіод(за допомогою клавіші g)
	      ...
	      case 'o': // Перемикаємо ОРАНЖЕВИЙ світлодіод(за допомогою клавіші o)
	      ...
	      case 'r': // Перемикаємо ЧЕРВОНИЙ світлодіод(за допомогою клавіші r)
	      ...
	      case 'b': // Перемикаємо СИНІЙ світлодіод(за допомогою клавіші b)
	      ...
	      case 'j': // Увімкнути ВСІ світлодіоди(за допомогою клавіші j)
	          HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15, GPIO_PIN_SET);
	          HAL_UART_Transmit(&huart3, (uint8_t *)" - All LEDs ON\r\n", 16, 100);
	          break;

	      case 'k': // Вимкнути ВСІ світлодіоди(за допомогою клавіші k)
